				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="index.jsp?type=farming equipment">FARMING EQUIPMENTS</a></li>
							<li><a href="index.jsp?type=farming supplies">FARMING SUPPLIES</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="userHome.jsp?type=farming equipment">FARMING EQUIPMENTS</a></li>
							<li><a href="userHome.jsp?type=farming supplies">FARMING SUPPLIES</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
