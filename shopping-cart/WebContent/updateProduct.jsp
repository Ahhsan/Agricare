				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="fruits"
								<%="mobile".equalsIgnoreCase(ptype) ? "selected" : ""%>>FRUITS</option>
							<option value="vegetables"
								<%="tv".equalsIgnoreCase(ptype) ? "selected" : ""%>>VEGETABLES</option>
							<option value="farming equipment"
								<%="camera".equalsIgnoreCase(ptype) ? "selected" : ""%>>FARMING EQUIPMENT</option>
							<option value="farming supplies"
								<%="laptop".equalsIgnoreCase(ptype) ? "selected" : ""%>>FARMING SUPPLIES</option>
							<option value="other"
								<%="tablet".equalsIgnoreCase(ptype) ? "selected" : ""%>>OTHER</option>
